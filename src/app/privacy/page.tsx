      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">
            How we handle your data on Parlay.sk
          </p>
        </div>
        ...
        <div className="bg-gray-800/50 rounded-2xl p-8 border border-gray-700">
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <p>
                This demonstration version stores all data locally in your browser using localStorage.
            ...
            <div>
              ...
              <p>
                Your data is used solely to provide the platform functionality. We do not share
                your information with third parties in this demonstration.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                You can clear all your data by using the "Reset Data" function in the admin panel
                or by clearing your browser's localStorage.
              </p>
            </div>
