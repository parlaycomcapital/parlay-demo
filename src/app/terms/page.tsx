    ...
    <div className="min-h-screen bg-[#0B132B]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">Terms and conditions for using Parlay.sk</p>
        </div>
        ...
        <div className="bg-gray-800/50 rounded-2xl p-8 border border-gray-700">
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <p>
                This is a demonstration version of Parlay.sk. All features are simulated and data is
            ...
            <div>
              ...
              <p>
                All content shared on this platform should be related to sports analysis and should
